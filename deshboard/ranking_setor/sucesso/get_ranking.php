...
foreach($colaboradores as $colaborador){
    ...
    $sql = $pdo->prepare('
        SELECT SUM(ponto_sucesso) as total_sucesso, COUNT(*) as num_avaliacoes
        FROM avaliacao_sucesso 
    ...
    $media_nota = $nota['num_avaliacoes'] > 0 ? $nota['total_sucesso'] / $nota['num_avaliacoes'] : 0;
