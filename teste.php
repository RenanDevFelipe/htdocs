...
<body>
    <nav>
        <a href="#" data-id="1">Formulário 1</a>
        <a href="#" data-id="2">Formulário 2</a>
        <a href="#" data-id="3">Formulário 3</a>
        <a href="#" data-id="4">Formulário 4</a>
        <a href="#" data-id="5">Formulário 5</a>
        <a href="#" data-id="6">Formulário 6</a>
    </nav>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('nav a').forEach(link => {
                link.addEventListener('click', event => {
                    ...
                    document.getElementById('show').innerHTML = forms[formId];
                });
            });
        });
    </script>
